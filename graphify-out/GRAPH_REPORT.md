...
## Corpus Check
- 46 files · ~11,696 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 257 nodes · 457 edges · 17 communities (14 shown, 3 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84b48918`
...
- `GameSession` --references--> `GameMode`  [EXTRACTED]
  src/hooks/useGameSession.ts → src/lib/types.ts
...
Cohesion: 0.43
Nodes (4): App(), TabBar(), tabs, useWakeLock()
...
Cohesion: 0.15
Nodes (14): RecordGameBar(), RecordGameBarProps, InfoModal(), InfoModalProps, MatchBoxes(), ScorePanel(), ScorePanelProps, GameSession (+6 more)
...
Cohesion: 0.12
Nodes (26): PlayerAssign(), PlayerAssignProps, PlayerListItem(), PlayerListItemProps, activePreset(), daysAgoIso(), FilterBar(), FilterBarProps (+18 more)
...
Cohesion: 0.14
Nodes (18): PageShell(), PageShellProps, AddPlayerInput(), AddPlayerInputProps, addPlayer(), archivePlayer(), DuplicatePlayerError, listPlayers() (+10 more)
